...
@Component
@Slf4j
public class LikeProducer implements RabbitTemplate.ConfirmCallback, RabbitTemplate.ReturnCallback {
    ...
    public void send(MessageVo messageVo) {
        ...
        rabbitTemplate.convertAndSend(RabbitConstant.CONFIRM_EXCHANGE, RabbitConstant.RK_LIKE, messageVo, correlationId);
    }
}
