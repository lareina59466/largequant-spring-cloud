...
@Component
@Slf4j
public class CommentProducer implements RabbitTemplate.ConfirmCallback, RabbitTemplate.ReturnCallback {
    ...
    public void send(MessageVo messageVo) {
        ...
        rabbitTemplate.convertAndSend(RabbitConstant.CONFIRM_EXCHANGE, RabbitConstant.RK_COMMENT, messageVo, correlationId);
    }
}
